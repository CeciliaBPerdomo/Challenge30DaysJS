...
// 2. Desestructure la siguiente matriz nombre a nombre, array de habilidades a habilidades, array 
// de puntuaciones a puntuaciones, puntuación de JavaScript a jsScore y puntuación de React a
// reactScore variable en una línea.

console.log("--------------------------")
console.log("EJERCICIO 2")
const student = [{"nameSt": "David", "skills" : ["HTM", "CSS", "JS", "React"], "puntuation": [98, 85, 90, 95]}];
for (const { nameSt, skills, puntuation } of student) {
    console.log(nameSt, skills, puntuation[2], puntuation[3]);
}
...
const alumnos = [
  ...
  function convertArrayToObject(alumnos){
    for (const [name, skills, score] of alumnos){
        //console.log({name, skills, score})
        json = {name, skills, score}
    }
    return json
  }
  console.log(convertArrayToObject(alumnos))

// Copie el objeto estudiante a newStudent sin mutar el objeto original. 
// En el nuevo objeto añade lo siguiente
console.log("--------------------------")
console.log("EJERCICIO 4")
const newStudent = { ...json};
...
const stDavid = {...studentDavid}
stDavid.skills.frontEnd = [{ skill: "HTML", level: 10 },
{ skill: "CSS", level: 8 },
{ skill: "JS", level: 8 },
{ skill: "React", level: 9 },
...
stDavid.skills.backEnd = [ { skill: "Node", level: 7 },
{ skill: "GraphQL", level: 8 }, {skill: "Express", level: 9}]

// Añadir SQL con nivel 8 a los conjuntos de habilidades de la base de datos
stDavid.skills.dataBase = [{ skill: "MongoDB", level: 7.5 }, {skill: "SQL", level: 8}]

// Añadir SQL sin nivel a los conjuntos de habilidades de ciencia de datos
stDavid.skills.dataScience = ["Python", "R", "D3.js", "SQL"]
console.log(stDavid)
console.log("--------------------------")